<?php
    ...
    $getWelcomeImageResult = mysqli_query($link , $getWelcomeImage) or die("Query failed");
?>
<html>
    <head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="welcomeImage.css">
    ...
    <body>
        <div class="container">
            ...
            <div>
                <div class="title">
                    <h1>Update Welcome Image</h1>
                </div>
                 <div class="error">
                        <?php if($_GET){echo $_GET['msg'];} ?>
                </div>
            ...
            <div class="imgContainer">
                ...
                <div>
                    <?php 
                        while ($imgFetchAssoc = mysqli_fetch_assoc($getWelcomeImageResult)){
                    ?>

                        <img src="../web3/welcomeimage/<?php echo $imgFetchAssoc['url']; ?>" style="width:50%"/> 
