...
<head>
    ...
    <link href="itemDetail.css" rel="stylesheet" type="text/css" />
...
<div class="container" style="margin-top:64px;">
    ...
    ?>
         <div class="row">
            ...
            <div class="col-7" style="height:81vh;">
                <div>
                    <img src="./itemImages/<?php echo $ItemFetchAssoc['image'] ?>" style="width:100%;height:75vh;"/>
                </div>
            </div>

            <div class="col-5 itemDetailContainer">

                <div class="itemDetailName">
                    <div>
                        <h1><?php echo $ItemFetchAssoc['name']; ?></h1>
                    </div>

                    <?php if(isset($_SESSION["userId"])){?>
                    
                            <div style="margin-top:8px; cursor:pointer;" id="favoriteContainer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" id="heart" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16" >
                                    <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>
                                </svg>
                            </div>
                    <?php }else{
                ...
                <div class="itemDetailPriceCategorie">
                    <div>
                        <h3>Price</h3>
                        <?php if($ItemFetchAssoc['discountprice'] === '0'){ ?>
                            <div>
                                <p><?php echo $ItemFetchAssoc['price']; ?>$</p>
                            </div>
                        <?php }else{ ?>
                ...
                <div class="itemStock">
                    ...
                    <div>  
                        <p><?php echo $ItemFetchAssoc['stock']; ?> Piece(s)</p>
                    </div>
                </div>
                <?php $url="addToCart.php"; ?>
                <form name="addToCart" action="<?php echo $url; ?>" method="post">
                    <div class="addToCarteContainer">
                        <?php if($ItemFetchAssoc['stock'] !== '0' ){
                                if(isset($_SESSION["userId"])){
                            ?>
                                <div class="itemId">
                                    <p>Item Id</p>
                                    <input type="number" name="itemId" id="itemId" value="<?php echo $id; ?>"/>
                                </div>
                                <div class="quantityInput">
                                    <input type="number" name="quantity" id="quantity" value="1" min="1" max="<?php echo $ItemFetchAssoc['stock']; ?>"/>
                                </div>
                            ...
                            <?php }else{ ?>
                                <div style="display:flex; flex-direction:column;">
                                    <div style="display:flex; flex-direction:row;">
                                        <div class="disquantityInput">
                                            <input type="number" name="disquantity" value="1" min="1" max="<?php echo $ItemFetchAssoc['stock']; ?>" disabled="disabled"/>
                                        </div>
                                        <a href="signin.php">
                                            <div class="disabledSubmitInput">
                                                Add to Cart
                                            </div>
                                        </a>
                                    </div>
                                    <div class="alert alert-danger" role="alert" style="margin-top:16px">
                                        You need an account to continue shopping!!
                                    </div>
                                </div>
                            <?php } ?>
                        ...
                        <?php }else{ ?>
                            ...
                            <div class="outOfStock">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" color="red" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
        ...
        <div class="row">
            <div class="col">
                <div class="itemDetailDescription">
                    <h2>Description</h2>
                    <p><?php echo $ItemFetchAssoc['description']; ?></p>
                </div>
            </div>
        </div>
...
<script type='text/javascript'>
       ...
       $('#favoriteContainer').click(function(){
            $.ajax({
                url: "favorite.php",
                success: function(){
                  window.location.href='favoriteItems.php';               
                }
                });
       });
