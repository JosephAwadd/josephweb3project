...
session_start();
    ...
    $getUserById = "SELECT * FROM `users` WHERE `users`.`id` = '$id';";
    $getUserByIdResult = mysqli_query($link , $getUserById) or die("Query failed ");
...
<div class="profileWrapper">
    <div class="userProfileContainer">
            ...
            <div class="profileFormContainer">
                <?php while ($profileFetchAssoc = mysqli_fetch_assoc($getUserByIdResult)){
                        $url= "updateUser.php?id=".$profileFetchAssoc['id'];
                    ?>
                    <form name="updateUserForm" action="<?php echo $url; ?>" method="post" >
                        <div class="fnlnContainer">
                            <div>
                                <p>First Name</p>
                                <input type="text" name="firstname" id="firstname" value="<?php echo $profileFetchAssoc['firstname'] ; ?>" />
                            </div>
                            <div>
                                <p>Last Name</p>
                                <input type="text" name="lastname"  id="lastname" value="<?php echo $profileFetchAssoc['lastname'] ; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="userEmailContainer">
                            <div>
                                <p>Userame</p>
                                <input type="text" name="username" id="username" value="<?php echo $profileFetchAssoc['username'] ; ?>" />
                            </div>
                            <div>
                                <p>Email</p>
                                <input type="email" name="email"  id="email" value="<?php echo $profileFetchAssoc['email'] ; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="adressContainer">
                            <div>
                                <p>Adress</p>
                                <input type="text" name="adress" id="adress" value="<?php echo $profileFetchAssoc['adress'] ; ?>" />
                            </div>
                        </div>
