...
$getItemsByCatName = "SELECT * FROM items WHERE `items`.`catname` = '$name';";
$getItemsByCatNameResult = mysqli_query($link , $getItemsByCatName) or die("Query failed 2");
...
<div class="container">
        ...
        <div class="featureItemContainer">
            <?php 
                while ($ItemFetchAssoc = mysqli_fetch_assoc($getItemsByCatNameResult)){
