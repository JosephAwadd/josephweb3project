...
$getCart = "SELECT * FROM `cart` WHERE `cart`.`userId`= '$id'";
$getCartResult = mysqli_query($link , $getCart) or die("Query failed ");
...
<head>
    ...
    <link href="myCart.css" rel="stylesheet" type="text/css" />
        ...
        <div class="myCartContainer">
            <table class="table table-striped">
                    ...
                    <tbody>
                         ...
                         <?php 
                             while ($CartFetchAssoc = mysqli_fetch_assoc($getCartResult)){
                                    $totalPrice += $CartFetchAssoc['price'] ;
                                ?>

                               <tr>
                                   <td style="width:20%">
                                        <img src="./itemImages/<?php echo $CartFetchAssoc['image']; ?>" style="width:100%"/>
                                   </td>
                                   <td style="width:30%">
                                        <?php 
                                            echo $CartFetchAssoc['name'];
                                        ?>
                                   </td>
                                   <td style="width:20%">
                                        <?php 
                                            echo $CartFetchAssoc['quantity'];
                                        ?>
                                   </td>
                                   <td style="width:20%">
                                        <?php 
                                            echo $CartFetchAssoc['price']."$";
                                        ?>
                                   </td>
                                   <td style="width:20%">
                                   <?php $url="removeFromCart.php?id=".$CartFetchAssoc['itemid']; ?> 
                                        <a href="<?php echo $url; ?>">
                                            <div class="deleteContainer" id="removeCart">
                                                DELETE
                                            </div>
                                        </a>
                                   </td>
...
<div class="container">
   <div class="priceCheckoutContainer">
        ...
        <div class="checkoutContainer">
            <form class="checkoutOrder" name="checkoutOrder" action="checkoutOrder.php" method="post">
                <?php if($totalPrice === 0){?>
                    <input type="submit" value="Checkout Order" disabled="disabled" style="cursor:no-drop;"/> 
                <?php }else{ ?>
